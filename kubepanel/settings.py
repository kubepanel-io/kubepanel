"""
Django settings for kubepanel project.
...
MIDDLEWARE = [
    'dashboard.middleware.login_security.LoginRateLimitMiddleware',
...
WSGI_APPLICATION = 'kubepanel.wsgi.application'
